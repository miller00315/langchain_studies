...
connection = (
    "postgresql+psycopg2://myuser:mypassword@0.0.0.0:5433/mydb"  # Uses psycopg3!
)
...
if __name__ == "__main__":
    ...
    with st.sidebar:
        ...
        k = st.number_input(
            "k  neighbors:", min_value=1, max_value=20, value=3, on_change=clear_history
        )
    ...
    if user_question:
        if "vector_store" in st.session_state:
            ...
            answer = ask_and_get_answer(vector_store=vector_store, q=user_question, k=k)
